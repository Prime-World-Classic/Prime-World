...
public:
  ...
  virtual rpc::CallResult::Enum Call(const rpc::MethodCallHeader& call, rpc::MethodCall& resultCall, rpc::Arguments& args, const byte* paramsData, int _paramsSize)
  {
    ...
    static const rpc::MethodInfo methods[] = 
    {
        ...
        { "lobby::IServerInstance::SpectateWebLobby", 1, false, rpc::GetMethodCode(&lobby::IServerInstance::SpectateWebLobby) },
    };
  ...
  virtual uint GetClassCrc() const { return 0xefd32bde; }
